...
public class Ex04_primitive_type {
	public static void main(String[] args) {
		 ...
		 * 		(4) 용도 : 이미지, 동영상 등을 그대로 저장하기 위한 byte배열용 
		 * 
		 * 	2) short
		 * 		(1) 크기 : 2바이트 (16비트)
		 * 		(2) 개수 : 2의 16제곱 (65,5336개) 
		 * 		(3) 범위 : -32,768 ~ 32,767
		 * 
		 * 	3) int
		 * 		(1) 크기 : 4바이트 (32비트)
		 * 		(2) 개수 : 2의 32제곱 (4,294,967,296 개) 
		...
		// 주의할 점
		System.out.println(ch1 + ch2);		// 'A'의 코드값 + '한'의 코드
		System.err.println("" + ch1 + ch2);	// A한
